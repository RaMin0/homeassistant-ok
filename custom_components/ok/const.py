...
SESSION_STATUS_INITIAL: Final = "initial"
SESSION_STATUS_PENDING: Final = "pending"
SESSION_STATUS_SCHEDULED: Final = "scheduled"
SESSION_STATUS_WAITING_FOR_CHARGE: Final = "waiting_for_charge"
SESSION_STATUS_CHARGING: Final = "charging"
SESSION_STATUS_CHARGING_SUSPENDED: Final = "charging_suspended"
SESSION_STATUS_CHARGING_SUSPENDED_AWAITING_AUTOMATIC_UNLOCK: Final = (
    "charging_suspended_awaiting_automatic_unlock"
)
SESSION_STATUS_REMOVE_CABLE: Final = "remove_cable"
SESSION_STATUS_FINISHED: Final = "finished"
SESSION_STATUS_ERROR: Final = "error"
SESSION_STATUS_UNAVAILABLE: Final = "unavailable"
SESSION_STATUS_UNKNOWN: Final = "unknown"

SESSION_STATUS_OPTIONS: Final = (
    SESSION_STATUS_INITIAL,
    SESSION_STATUS_PENDING,
    SESSION_STATUS_SCHEDULED,
    SESSION_STATUS_WAITING_FOR_CHARGE,
    SESSION_STATUS_CHARGING,
    SESSION_STATUS_CHARGING_SUSPENDED,
    SESSION_STATUS_CHARGING_SUSPENDED_AWAITING_AUTOMATIC_UNLOCK,
    SESSION_STATUS_REMOVE_CABLE,
...
SESSION_STATUS_BY_RAW_STATUS: Final = {
    "Initial": SESSION_STATUS_INITIAL,
    "initial": SESSION_STATUS_INITIAL,
    "Pending": SESSION_STATUS_PENDING,
    "pending": SESSION_STATUS_PENDING,
    "Scheduled": SESSION_STATUS_SCHEDULED,
    "scheduled": SESSION_STATUS_SCHEDULED,
    "WaitingForCharge": SESSION_STATUS_WAITING_FOR_CHARGE,
    "waitingForCharge": SESSION_STATUS_WAITING_FOR_CHARGE,
    "waiting_for_charge": SESSION_STATUS_WAITING_FOR_CHARGE,
    "Charging": SESSION_STATUS_CHARGING,
    "charging": SESSION_STATUS_CHARGING,
    "ChargingSuspended": SESSION_STATUS_CHARGING_SUSPENDED,
    "chargingSuspended": SESSION_STATUS_CHARGING_SUSPENDED,
    "charging_suspended": SESSION_STATUS_CHARGING_SUSPENDED,
    "ChargingSuspendedAwaitingAutomaticUnlock": (
        SESSION_STATUS_CHARGING_SUSPENDED_AWAITING_AUTOMATIC_UNLOCK
    ),
    "chargingSuspendedAwaitingAutomaticUnlock": (
        SESSION_STATUS_CHARGING_SUSPENDED_AWAITING_AUTOMATIC_UNLOCK
    ...
    "RemoveCable": SESSION_STATUS_REMOVE_CABLE,
    "removeCable": SESSION_STATUS_REMOVE_CABLE,
    "remove_cable": SESSION_STATUS_REMOVE_CABLE,
    "Finished": SESSION_STATUS_FINISHED,
    "finished": SESSION_STATUS_FINISHED,
    "Error": SESSION_STATUS_ERROR,
    "error": SESSION_STATUS_ERROR,
    "Unavailable": SESSION_STATUS_UNAVAILABLE,
    "unavailable": SESSION_STATUS_UNAVAILABLE,
    "Unknown": SESSION_STATUS_UNKNOWN,
    "unknown": SESSION_STATUS_UNKNOWN,
}
